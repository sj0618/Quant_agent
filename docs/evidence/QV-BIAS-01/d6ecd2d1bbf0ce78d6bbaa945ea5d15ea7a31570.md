# QV-BIAS-01 evidence bundle — `d6ecd2d`
...
> baseline·sliced result·covered signal count·limitation이 있음
...
```sh
cd ai && … -m pytest -q tests/test_lookahead_evidence.py
```
...
`docs/evidence/QV-BIAS-01/29eaef2295d2e2c04c63bbfdd705cbf2d90ce61a.md` 참조.
