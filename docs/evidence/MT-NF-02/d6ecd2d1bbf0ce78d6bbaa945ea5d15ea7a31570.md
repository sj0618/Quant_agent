# MT-NF-02 evidence bundle — `d6ecd2d`
...
> 0.0 default 없이 availability/reason이 전달됨
...
```sh
cd ai && … -m pytest -q tests/contracts/test_metric_api_serialization_contract.py tests/test_quant_performance.py
```

`exit=0` — `16 passed in 0.23s`.
...
`docs/evidence/MT-NF-02/29eaef2295d2e2c04c63bbfdd705cbf2d90ce61a.md` 참조.
