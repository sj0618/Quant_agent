# OD-DIG-01 evidence bundle — `d6ecd2d`
...
> 410 또는 route absence, LLM 호출 0회
...
```sh
cd ai && … -m pytest -q tests/test_api.py::test_retired_daily_digest_returns_gone_without_audit_or_llm tests/test_daily_digest.py
```

`exit=0` — `8 passed, 1 warning in 0.33s`.
...
`docs/evidence/OD-DIG-01/29eaef2295d2e2c04c63bbfdd705cbf2d90ce61a.md` 참조.
