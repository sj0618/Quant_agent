# FT-JOB-07 evidence bundle — `d6ecd2d`
...
```sh
cd ai && … -m pytest -q tests/test_jobs.py tests/test_interrupted_job_reaper.py tests/test_legacy_job_rows.py
```

`exit=0` — `31 passed, 1 warning in 0.35s`.
...
`docs/evidence/FT-JOB-07/29eaef2295d2e2c04c63bbfdd705cbf2d90ce61a.md` 참조.
