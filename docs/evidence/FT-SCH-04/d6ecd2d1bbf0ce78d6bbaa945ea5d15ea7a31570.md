# FT-SCH-04 evidence bundle — `d6ecd2d`
...
```sh
cd ai && … -m pytest -q tests/contracts/test_api_envelope_contract.py tests/test_screening_pipeline_failure_classifier.py
```

`exit=0` — `13 passed, 1 warning in 1.53s`.
...
`docs/evidence/FT-SCH-04/29eaef2295d2e2c04c63bbfdd705cbf2d90ce61a.md` 참조.
