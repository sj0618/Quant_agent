# FT-EMPTY-05 evidence bundle — `d6ecd2d`
...
> empty error code, no cache reuse, no recommendation PASS
...
```sh
cd ai && … -m pytest -q tests/test_screening_pipeline_failure_classifier.py
```
...
`docs/evidence/FT-EMPTY-05/29eaef2295d2e2c04c63bbfdd705cbf2d90ce61a.md` 참조.
