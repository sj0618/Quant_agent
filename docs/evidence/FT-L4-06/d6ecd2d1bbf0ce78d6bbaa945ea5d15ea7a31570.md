# FT-L4-06 evidence bundle — `d6ecd2d`
...
```sh
cd ai && … -m pytest -q tests/test_freshness_propagation.py tests/test_signal.py
```

`exit=0` — `20 passed in 0.21s`.
...
`docs/evidence/FT-L4-06/29eaef2295d2e2c04c63bbfdd705cbf2d90ce61a.md` 참조.
