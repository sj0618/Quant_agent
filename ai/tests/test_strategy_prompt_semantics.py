...
PROMPT_CASES = [
    ...
    ("bollinger_squeeze_breakout", "볼린저밴드 하단 이탈 후 종가 기준으로 밴드 안에 재진입한 단기 반등 후보를 찾아줘."),
    ...
    ("trend_rsi_volume_pullback", "200일선 위 상승추세를 유지하면서 RSI(14)가 40 이하로 눌리고 거래량이 20일 평균 이상인 종목을 찾아줘."),
