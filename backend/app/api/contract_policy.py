...
TRACK_C_CONTRACT_POLICY: tuple[EndpointContract, ...] = (
    ...
    contract(
        ...
        auth_required=True,
        csrf_required_for_unsafe=False,
        summary="List email strategy subscriptions for the current owner.",
        required_dependency="main DB engine",
    ),
    contract(
        "POST",
        ...
        auth_required=True,
        csrf_required_for_unsafe=True,
        summary="Create an owned email strategy subscription.",
        required_dependency="main DB engine",
    ),
    contract(
        "DELETE",
        "/api/v1/me/email-strategy-subscriptions/{strategy_id}",
        implementation=ContractImplementation.DB_BACKED,
        visibility=ContractVisibility.AUTHENTICATED,
        production_ready=True,
        fe_live_allowed=True,
        auth_required=True,
        csrf_required_for_unsafe=True,
        summary="Remove an owned email strategy subscription.",
        required_dependency="main DB engine",
    ),
    contract(
        "GET",
